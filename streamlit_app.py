...
if select == "Introduction":
    ...
    st.markdown(center_content("We from Group 3 Industrial Engineering 1, introduce an image transformation application based on Streamlit.", 3), unsafe_allow_html=True)
